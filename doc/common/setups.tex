...
%%									% am Fuß einer Seite steht, und alles andere
%%									% dann auf der nächsten
%		\par%						% Zeilenumbruch erzwingen
%		\noindent%					% Keinen Einzug
%		\textbf{Aufgabe \theproblemnb\ (Durchführung/Nachbearbeitung):}%
%		\begin{itemize}}%
%	{\end{itemize}%
%		\vspace{3ex}}
...
%{\vspace{2ex} \@beginparpenalty=10000 \par \noindent \textbf{Lösung zu Aufgabe~\ref{#1}:}\begin{itemize}}%
%{\end{itemize}\vspace{3ex}}
%\makeatother
%% =================================================================================
